    ...
    cards: [
      {
        ...
        description:
          "인쇄용 PET(Polyethylene Terephthalate) 필름은 인쇄 공정에 적합하도록 처리된 PET 필름으로, 고해상도 이미지나 텍스트를 정밀하게 표현할 수 있어 산업용, 포장용, 광고용, 전자재료 등 다양한 분야에 활용 됩니다. 표면이 코로나 처리, 프라이머 코팅 등으로 처리되어 잉크 밀착력이 우수하며, 내수성, 내습성, 내열성, 내화학성이 좋다는 장점이 있습니다.",
